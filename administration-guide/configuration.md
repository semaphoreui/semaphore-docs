...
| `oidc_providers` ![Static Badge](https://img.shields.io/badge/new-red)    | | OpenID provider settings. You can provie multible OpenID providers. More about OpenID configuration read in [OpenID](openid.md). |

...
Use this option if the Semaphore server is located in a private network.

#### SSL

Semaphore doesn't support SSL. You should use an NGINX, or an Apache web server in front of Semaphore to serve secure connections.

...
| [Authentification](/admin-guide/authentication) | Comptes locaux et double authentification, LDAP et Active Directory, et authentification unique avec douze fournisseurs OpenID Connect. |

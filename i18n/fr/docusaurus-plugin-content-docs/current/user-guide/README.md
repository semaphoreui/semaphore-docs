...
| [Host config](/user-guide/host-config) | Identifiants pour les hôtes Git et les URL de dépôts que la clé du dépôt ne couvre pas : sous-modules, rôles Galaxy, modules Terraform. |

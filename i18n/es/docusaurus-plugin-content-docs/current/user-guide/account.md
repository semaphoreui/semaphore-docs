...
| **Tokens de API** | Tokens personales para la [API REST](/admin-guide/api). |
...
Use el token en la cabecera `Authorization: Bearer`, consulte [API](/admin-guide/api). Para revocar un token, elimínelo de la lista.

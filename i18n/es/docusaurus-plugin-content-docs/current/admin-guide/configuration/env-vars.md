...
Semaphore no transmite su propio entorno a los procesos que inicia. Salvo `PATH`, una variable llega a una tarea o a un clonado de `git` solo si está listada en `forwarded_env_vars` o definida en `env_vars`.

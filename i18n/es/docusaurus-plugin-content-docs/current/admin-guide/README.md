...
| [Autenticación](/admin-guide/authentication) | Cuentas locales y doble factor, LDAP y Active Directory, e inicio de sesión único con doce proveedores de OpenID Connect. |

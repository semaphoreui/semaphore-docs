...
| [Host config](/user-guide/host-config) | Credenziali per host Git e URL di repository non coperti dalla chiave del repository: sottomoduli, ruoli Galaxy, moduli Terraform. |

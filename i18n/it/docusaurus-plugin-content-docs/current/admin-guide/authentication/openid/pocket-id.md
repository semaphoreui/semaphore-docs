...
Le informazioni sono disponibili anche sul sito di Pocket-ID nella sezione Client Examples: [Pocket-ID Client Examples - Semaphore UI](https://pocket-id.org/docs/client-examples/semaphore-ui/).

...
* [GitHub 配置](/admin-guide/openid/github)
* [Google 配置](/admin-guide/openid/google)
* [GitLab 配置](/admin-guide/openid/gitlab)
* [Authelia 配置](/admin-guide/openid/authelia)
* [Authentik 配置](/admin-guide/openid/authentik)
* [Keycloak 配置](/admin-guide/openid/keycloak)
* [Okta 配置](/admin-guide/openid/okta)
* [PingFederate 配置](/admin-guide/openid/pingfederate)
* [Azure 配置](/admin-guide/openid/azure)
* [Zitadel 配置](/admin-guide/openid/zitadel)
* [Pocket-ID 配置](/admin-guide/openid/pocket-id)

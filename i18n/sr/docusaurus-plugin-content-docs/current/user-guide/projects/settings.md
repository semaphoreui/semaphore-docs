...
**Test alerts** šalje testnu poruku kroz svaki konfigurisani [kanal za obaveštenja](/category/notifications), tako da možete proveriti konfiguraciju servera bez pokretanja zadatka. **Save** primenjuje izmene.
...
- Kanali za obaveštenja se konfigurišu na serveru: [Obaveštenja](/category/notifications)

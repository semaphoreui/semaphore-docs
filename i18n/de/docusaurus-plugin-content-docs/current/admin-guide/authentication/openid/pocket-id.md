...
Informationen finden Sie auch auf der Pocket-ID-Website unter Client Examples: [Pocket-ID Client Examples - Semaphore UI](https://pocket-id.org/docs/client-examples/semaphore-ui/).

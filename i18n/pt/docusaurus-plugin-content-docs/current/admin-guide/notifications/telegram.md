...
Cada projeto pode usar um ID de chat exclusivo.  Isso permite separar as notificações por projeto em vez de enviá-las todas para o mesmo chat. Isso sobrescreve o ID de chat global definido acima. Defina-o na aba [Alertas](/user-guide/projects/alerts#server-channels) do projeto, ou crie um [alerta do projeto](/user-guide/projects/alerts#project-alerts) do tipo Telegram para atingir vários chats ou um tópico de fórum.

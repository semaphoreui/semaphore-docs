...
Информация также есть на сайте Pocket-ID в разделе Client Examples: [Pocket-ID Client Examples - Semaphore UI](https://pocket-id.org/docs/client-examples/semaphore-ui/).
